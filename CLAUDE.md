...
Trois dossiers `<viz-slug>/` existent à ce stade, adaptés de drafts externes : `biodiversity/`, `bird-migrations/`, `flower-phenology/`. Les trois sont implémentées (étape 8 de `BUILD-PLAN.md`, fait).
