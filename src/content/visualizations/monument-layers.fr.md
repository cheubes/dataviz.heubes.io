---
lang: fr
title: Les strates du patrimoine
summary: "Quarante-cinq mille monuments historiques français, de leur plus ancienne pierre connue à aujourd'hui : une carte qui se construit sous vos yeux, siècle après siècle."
datasets:
  - name: Immeubles protégés au titre des monuments historiques (base Mérimée)
  ...
  - name: Cours d'eau (tracé)
    publisher: OpenStreetMap contributors
    url: https://www.openstreetmap.org/copyright
    license: Open Database License (ODbL)
    retrieved: '2026-09-10'
  - name: Réseau routier (autoroutes et voies rapides)
    publisher: OpenStreetMap contributors
    url: https://www.openstreetmap.org/copyright
    license: Open Database License (ODbL)
    retrieved: '2026-09-10'
