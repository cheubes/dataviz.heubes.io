---
lang: fr
title: Les lignes de faille
summary: "Plus d'un siècle de séismes majeurs rejoués en boucle : leurs pulses dessinent, sans qu'on ait besoin de le dire, les frontières des plaques tectoniques."
datasets:
  - name: Earthquake Catalog (fdsnws/event)
    publisher: United States Geological Survey (USGS)
    url: https://earthquake.usgs.gov/fdsnws/event/1/
    license: Public domain (U.S. federal government data)
    retrieved: '2026-09-16'
  - name: Tectonic plate boundaries (Bird, 2003 model)
    publisher: Peter Bird, redistributed by Hugo Ahlenius / Nordpil
