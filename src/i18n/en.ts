export default {
  ...
  animalMigrations: {
    ...
    empty: 'No phenomenon for this combination of filters.',
    play: 'Play',
    pause: 'Pause',
    speedLabel: 'Speed',
    speedSlow: 'Slow',
    ...
    individualLabel: 'Individual',
    distanceLabel: 'Distance covered:',
    durationLabel: 'Duration covered:',
    durationUnit: 'days',
    densityTooltipLabel: 'Observations in {month}:',
    densityTooltipSuffix: '% of the annual peak here',
  },
};
