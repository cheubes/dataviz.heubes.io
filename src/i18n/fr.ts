export default {
  ...
  animalMigrations: {
    loading: 'Chargement des migrations…',
    error: 'Impossible de charger les données de migration. Réessayez plus tard.',
    empty: 'Aucun phénomène pour cette combinaison de filtres.',
    play: 'Lecture',
    pause: 'Pause',
    speedLabel: 'Vitesse',
    speedSlow: 'Lent',
    ...
    individualLabel: 'Individu',
    distanceLabel: 'Distance parcourue :',
    durationLabel: 'Durée couverte :',
    durationUnit: 'jours',
    densityTooltipLabel: 'Observations en {month} :',
    densityTooltipSuffix: '% du pic annuel ici',
  },
};
