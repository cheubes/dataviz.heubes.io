...
- **The Great Migrations** ([`animal-migrations`](specs/animal-migrations/)) : a single world map combining three real migration mechanics — individual GPS/Argos tracks of humpback and blue whales and of Mara wildebeest (Movebank Data Repository), and GBIF occurrence density for the monarch butterfly aggregated on a regular North American grid — rendered as Canvas 2D on the same world basemap as Bird Migrations.
